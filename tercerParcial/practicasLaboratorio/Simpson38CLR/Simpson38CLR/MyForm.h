...
namespace Simpson38CLR {				//Cambiar CLRWindowsForms por nombre del proyecto
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"MyForm";
			this->Text = L"Integral. Simpson 3/8";
...
#pragma endregion
	...
	private: System::Void botonIntegrar_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		listBox1->Items->Add(
			"Resultado: " + 
			A.Simpson38(Convert::ToDouble(cajaXa->Text), Convert::ToDouble(cajaXb->Text), Convert::ToDouble(cajaN->Text), ind)
		);
	}
