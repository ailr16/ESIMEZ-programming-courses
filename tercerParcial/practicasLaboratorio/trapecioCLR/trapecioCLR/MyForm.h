...
namespace trapecioCLR {				//Cambiar CLRWindowsForms por nombre del proyecto
...
#pragma endregion
	...
	private: System::Void botonIntegrar_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		listBox1->Items->Add(
			A.trapecio(Convert::ToDouble(cajaXa->Text), Convert::ToDouble(cajaXb->Text), Convert::ToDouble(cajaN->Text), ind)
		);
	}
