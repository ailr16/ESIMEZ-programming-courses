...
namespace EulerCLR {				//Cambiar CLRWindowsForms por nombre del proyecto
...
#pragma endregion
	...
	private: System::Void botonIntegrar_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		listBox1->Items->Add(
			"y(" + cajaX->Text + ") = " +
			A.Euler(Convert::ToDouble(cajaX0->Text), Convert::ToDouble(cajaY0->Text), Convert::ToDouble(cajaX->Text), Convert::ToDouble(cajaN->Text), ind)
		);
	}
