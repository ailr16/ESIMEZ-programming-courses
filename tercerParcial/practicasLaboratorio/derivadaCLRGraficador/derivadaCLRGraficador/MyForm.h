...
namespace derivadaCLRGraficador {				//Cambiar CLRWindowsForms por nombre del proyecto
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		listBox1->Items->Add("Derivada: f'(" + d1.regresaAlgunValorDeX(0) + ")=   " + resultadoDerivada);
