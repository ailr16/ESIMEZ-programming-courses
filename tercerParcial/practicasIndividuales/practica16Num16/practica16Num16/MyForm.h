...
namespace practica16Num16 {				//Cambiar CLRWindowsForms por nombre del proyecto
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// cajaInterpolar
			// 
			this->cajaInterpolar->Location = System::Drawing::Point(120, 110);
			...
			// botonLeer
			// 
			this->botonLeer->Location = System::Drawing::Point(82, 306);
			...
			this->dataGridView1->Location = System::Drawing::Point(6, 136);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(237, 164);
			...
			// cajaPuntos
			// 
			this->cajaPuntos->Location = System::Drawing::Point(120, 85);
			...
			this->label3->Text = L"Instrucciones:\r\n1. Proponer n numero de puntos.\r\n2. Proponer valor a interpolar.\r"
				L"\n3. Proponer puntos igualmente espaciados.\r\n4. Leer puntos, aplicar metodo y gra"
				L"ficar.";
			// 
			// MyForm
			// 
			...
			this->Name = L"MyForm";
			this->Text = L"Practica 16 (Diferencias finitas)";
