...
namespace practica11Num16 {				//Cambiar CLRWindowsForms por nombre del proyecto
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->botonJacobi->Text = L"Metodo de Gauss-Seidel";
			...
			this->Name = L"MyForm";
			this->Text = L"Practica 11 Metodo de Gauss-Seidel";
