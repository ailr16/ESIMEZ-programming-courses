...
namespace practica15Num16 {				//Cambiar CLRWindowsForms por nombre del proyecto
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// cajaInterpolar
			// 
			this->cajaInterpolar->Location = System::Drawing::Point(117, 117);
			...
			this->label2->Location = System::Drawing::Point(20, 121);
			...
			this->dataGridView1->Location = System::Drawing::Point(6, 144);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(237, 157);
			this->dataGridView1->TabIndex = 2;
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Location = System::Drawing::Point(17, 94);
			...
			// cajaPuntos
			// 
			this->cajaPuntos->Location = System::Drawing::Point(117, 91);
			...
			this->label3->Size = System::Drawing::Size(199, 65);
			this->label3->TabIndex = 5;
			this->label3->Text = L"Instrucciones:\r\n1. Proponer n puntos.\r\n2. Proponer valor a interpolar.\r\n3. Ingres"
				L"ar puntos.\r\n4. Leer puntos, aplicar metodo y graficar.";
			// 
			// MyForm
			// 
			...
			this->Name = L"MyForm";
			this->Text = L"Practica 15 (Diferencias divididas)";
