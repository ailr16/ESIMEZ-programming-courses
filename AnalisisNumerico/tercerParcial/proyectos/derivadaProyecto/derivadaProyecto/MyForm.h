...
namespace derivadaProyecto {				//Cambiar CLRWindowsForms por nombre del proyecto
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Size = System::Drawing::Size(535, 336);
			...
			this->pictureBox2->Location = System::Drawing::Point(578, 24);
